...
const About = () => {
  return (
    <div>
      ...
      <div className={s.confidential}>CONFIDENTIAL INFORMATION READ BELOW</div>
      <div className={s.paragraph}>
        I am a full stack software developer, I was based on the theme of the
        animated cartoon Rick and Morty, this design was made using the react
        library, and stylized with css modules, if you have any questions do not
        hesitate to contact me on linkedIn, in my letter you will find the logo
        of the page that will take you directly to my profile. Greetings human!
        :)
      </div>
    </div>
  );
